...
#Gir dataframen et nytt navn (df)
...
#Bruker også theme for og bytte bakgrunn 
#Bruker annotate til og putte inn txt boks
...
#Plotter så in variablene jeg trenger for å lage grafen
covid %>%
